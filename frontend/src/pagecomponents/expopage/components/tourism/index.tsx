      ...
      <StyledCardContainer>
        ...
        <StyledCardBoxContainer>
          ...
          <StyledCardTextBox>
            ...
            <StyledCardTextContent>공룡엑스포만 보고 </StyledCardTextContent>
            <StyledCardTextContent>돌아가기 아쉬울 </StyledCardTextContent>
            <StyledCardTextContent>가족들을 위한 고성관광지 </StyledCardTextContent>
          </StyledCardTextBox>
        </StyledCardBoxContainer>
        <StyledCardBoxContainer>
          ...
          <StyledCardTextBox>
            ...
            <StyledCardTextContent>아이들이랑 함께 자기 좋은</StyledCardTextContent>
            <StyledCardTextContent>숙박시설!</StyledCardTextContent>
            <StyledCardTextContent>키즈 풀빌라, 청결 모두</StyledCardTextContent>
            <StyledCardTextContent>챙겨보세요</StyledCardTextContent>
          </StyledCardTextBox>
        </StyledCardBoxContainer>
      </StyledCardContainer>
      <StyledGOsungContainer>
